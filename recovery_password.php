...
<html lang="">
  <head>
    ...
    <script src="scripts/recovery_password.js"></script>
  ...
  <body>
    ...
    <main>
      ...
      <div class="g-medium--full g-wide--full card material">
      	...
      	<h2>Password dimenticata</h2><hr><br>
      	<p class="medium color--danger">Inserisci il tuo indirizzo email e riceverai subito una nuova password.</p>
      	<p style="margin-top: 10px;">Indirizzo email: <input type="email" id="email" placeholder="Email" /></p><br>
      	<button class="button--primary material" onclick="nuovaPassword()">Nuova Password</button>
